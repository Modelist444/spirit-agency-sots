...
const About = () => {
    ...
    return (
        <section id="about" className="relative z-20 py-24 overflow-hidden">
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-24">

                    <h2
                        className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black mb-6 tracking-tight text-white leading-normal pb-8 animate-spirit-passage whitespace-nowrap"
                    >
                        SPIRIT{' '}
                    ...
                    <div className="h-1.5 w-32 md:w-48 bg-gradient-to-r from-amber-400 to-orange-600 mx-auto rounded-full shadow-lg" />
